...
function start() {
  ...
  for (
    var a = document.querySelectorAll(".github-widget"), b = 0;
    b < a.length;
    b++
  ) {
    var c = a[b];
    ...
    appendToWidget(
      ...
      "div",
      "",
      '<div class="gh-widget-container"><div class="gh-widget-item gh-widget-photo"></div><div class="gh-widget-item gh-widget-personal-details"></div></div><div class="gh-widget-container gh-widget-stats"></div><hr class="gh-widget-hr"><div class="gh-widget-container"><div class="gh-widget-container"><div class="gh-widget-item gh-widget-follow"></div><div class="gh-widget-item gh-widget-active-time"></div></div>'
    );
...
function updateLastPush(a, b) {
  appendToWidget(
    b + " .gh-widget-active-time",
    "span",
    "",
    "Last active: " + (a ? a + " day(s) ago" : "Today")
  );
}
...
function updateUserDetails(a, b) {
  appendToWidget(
    b + " .gh-widget-personal-details",
    "div",
    "full-name",
    a.name
  );
  a.bio &&
    appendToWidget(b + " .gh-widget-personal-details", "div", "bio", a.bio);
  a.location &&
    appendToWidget(
      b + " .gh-widget-personal-details",
      "div",
  ...
  appendToWidget(
    ...
    '<div class="count">' +
      a.following +
      '</div><div class="stat-name">Following</div>'
  );
  appendToWidget(
    b + " .gh-widget-stats",
    "div",
...
function updateRepoDetails(a, b) {
  for (var c = 0; c < a.length; c++)
    appendToWidget(
      b + " .gh-widget-repositories",
      "div",
      "gh-widget-container",
      '<div class="gh-widget-item names"><div><a class="gh-widget-link" href="' +
        a[c].repoUrl +
        '">' +
        a[c].name +
        '</a></div></div><div class="gh-widget-item language"><div>' +
        (a[c].language ? a[c].language : "Unknown") +
        '</div></div><div class="gh-widget-item stars"><div>&#9733;' +
        a[c].stars +
        "</div></div>"
    );
}
